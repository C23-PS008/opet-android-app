...
object SearchBreedConfirmImageDestination: NavigationDestination {
    override val route: String = "search-breed-confirm-image"
...
@Composable
fun SearchBreedConfirmImageScreen(
    modifier: Modifier = Modifier,
    viewModel: SearchBreedConfirmImageViewModel = viewModel(factory = AppViewModelProvider.Factory),
    onNavigateUp: () -> Unit,
